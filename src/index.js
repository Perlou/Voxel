...
Main.prototype = {
	...
	'create' : function(){
		...
		var worksData = [
			{ image : require('./images/worksimg1.jpg'), text : '测试文本11111' },
			{ image : require('./images/worksimg2.jpg'), text : '测试文本22222' },
			{ image : require('./images/worksimg3.jpg'), text : '测试文本33333' },
			{ image : require('./images/worksimg4.jpg'), text : '测试文本44444' },
		];

		var courseData = [
			{ bg : require('./images/binoli.png'),  text : '测试文本111111' },
			{ bg : require('./images/bks.png'),  text : '测试文本222222' },
			{ bg : require('./images/gu.png'),  text : '测试文本333333' },
			{ bg : require('./images/hlx.png'),  text : '测试文本444444' },
			{ bg : require('./images/hlx.png'),  text : '测试文本555555' },
			{ bg : require('./images/gu.png'),  text : '测试文本666666' },
			{ bg : require('./images/bks.png'),  text : '测试文本777777' },
			{ bg : require('./images/binoli.png'),  text : '测试文本888888' },
			{ bg : require('./images/binoli.png'),  text : '测试文本999999' },
			{ bg : require('./images/bks.png'),  text : '测试文本101010' },
			{ bg : require('./images/gu.png'),  text : '测试文本111111' },
			{ bg : require('./images/hlx.png'),  text : '测试文本121212' },
		];
		...
		for( var i=0; i<worksData.length; i++){
			...
			cWorksDiv.innerHTML = '<img class="worksImg" src="'+(worksData[i].image)+'" /><div class="worksImgMark"><span>'+(worksData[i].text)+'</span><div></div></div>';
	...
	'music' : function(){
		...
		this.oMusic.onclick = function(){
			if(onoff){
				_this.oMusic.style.background = 'url('+ require('./images/musicon.gif') +')';
				_this.oAudio.play();
			}
			else{
				_this.oMusic.style.background = 'url(' + require('./images/musicoff.gif') +')';
				_this.oAudio.pause();
			}
			onoff = !onoff;
		};
